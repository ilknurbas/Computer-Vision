...
# P2 = np.zeros((3, 4)) # replace me
# P2 = np.zeros((3, 4)) # replace me
# coords = dict() # replace me
##--your-code-ends-here--##
...
homog = np.hstack((ABCDEFGH_w, np.ones((ABCDEFGH_w.shape[0], 1))))
img_1 = P1t @ homog.T
img_2 = P2t @ homog.T
...
##-your-code-starts-here-##
temp = np.vstack((Xc, np.ones((1, Xc.shape[1]))))
img_1 = P1 @ temp
img_2 = P2 @ temp
pcx1 = img_1[0, :] / img_1[2, :]
pcy1 = img_1[1, :] / img_1[2, :]
pcx2 = img_2[0, :] / img_2[2, :]
pcy2 = img_2[1, :] / img_2[2, :]
